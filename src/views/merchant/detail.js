...
import { Table,Form,Radio,Card, Icon,Input,Select,Button,Spin,Upload } from 'antd';
...
class merchantDetail extends React.Component {
 ...
 handleTableChange(pager, filters, sorter) {
  ...
  render() {
  	const {loading,detail,imgs } = this.props
...
function mapStateToProps(state) {
  ...
  return {detail: merchant.detail,imgs: merchant.imgs,loading:merchant.loading};
